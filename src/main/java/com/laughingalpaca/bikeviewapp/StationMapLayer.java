...
public class StationMapLayer extends MapLayer {
        ...
        for (Station station : stationList) {
            ...
            circle.setOnMouseClicked(mouseEvent -> {
                if (mouseEvent.getButton() == MouseButton.PRIMARY) {
                    ...
                    labels[2].setText(String.valueOf(truncateCoordinate(station.getLocation().getLatitude())));
                    labels[3].setText(String.valueOf(truncateCoordinate(station.getLocation().getLongitude())));
    ...
    public StationMapLayer(List<Station> stationList) {
        for (Station station : stationList) {
            Circle circle = new Circle(5, Color.web("#625bb2"));
            circle.setStroke(Color.web("#2b2751"));
            circle.setStrokeWidth(3);
    ...
    protected static double truncateCoordinate(double value) {
        return new BigDecimal(String.valueOf((value))).setScale(5, RoundingMode.DOWN).doubleValue();
    }
}
